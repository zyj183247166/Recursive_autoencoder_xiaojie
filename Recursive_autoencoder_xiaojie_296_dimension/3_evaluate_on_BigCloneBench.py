...
#    analyse(distance_pkl=id_pair_map_distance_pkl_trainedWeighted_root,metrics_pkl=metrices_weightedRAE_root_pkl)
    ...
    ##########质心模型，考虑左右叶子节点
#    idMapVector_PKL_Path_trainedWeighted_root='./vector/diffweight/ZHIXIN_mzvpb_using_Weigthed_RAE_BigCloneBenchFunction_ID_Map_Vector_root.xiaojiepkl'
#    id_pair_map_distance_pkl_trainedWeighted_root='./distance/diffweight/ZHIXIN_mzvpb_IDPairinBigCloneBench_Map_Distance_root.xiaojiepkl'
#    save_distance_file(bigCloneBenchIdPair_PKL_Path=bigCloneBenchIdPair_PKL_Path,idMapVector_PKL_Path=idMapVector_PKL_Path_trainedWeighted_root,id_pair_map_distance_pkl=id_pair_map_distance_pkl_trainedWeighted_root)
#    metrices_weightedRAE_root_pkl='./result/diffweight/ZHIXIN_mzvpb_metrices_root.xiaojiepkl'
#    analyse(distance_pkl=id_pair_map_distance_pkl_trainedWeighted_root,metrics_pkl=metrices_weightedRAE_root_pkl)
