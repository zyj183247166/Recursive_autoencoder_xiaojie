...
#####质心模型
        ##########质心模型
    metrices_ZHIXIN_root_pkl='./result/diffweight//ZHIXIN_zwimn_metrices_weightedRAE_root.xiaojiepkl'
    
#    result_weightedRAE_root=read_from_pkl(metrices_ZHIXIN_root_pkl)
    
        ##########质心模型，考虑左右叶子节点
    metrices__root_pkl_2='./result/diffweight/ZHIXIN_mzvpb_metrices_root.xiaojiepkl'
#    result_random_root=read_from_pkl(metrices__root_pkl_2)



######################保存的结果是：在weighted网络上，训练后，编码后用根节点进行度量######################    
    
    metrices_diffweightedRAE_root='./result/diffweight/diffW_random_quyko_metrices_weightedRAE_root.xiaojiepkl'
#    result_weightedRAE_root=read_from_pkl(metrices_diffweightedRAE_root)
######################保存的结果是：在weighted网络上，训练后，编码后用根节点进行度量######################   
...
###random_mean模型  
    ...
    yuzhi_random_mean=[]
    FPR_random_mean=[]
    recall_T1_random_mean=[]
    recall_T2_random_mean=[]
    recall_VST3_random_mean=[]
    recall_ST3_random_mean=[]
    recall_MT3_random_mean=[]
    recall_WT3_T4_random_mean=[]
    for obj in result_random_mean.items():
        ...
        recall_T1_random_mean.append(recall_T1)
        recall_T2=cal_recall(TP_T2c+TP_T2b,FN_T2c+FN_T2b)
        recall_T2_random_mean.append(recall_T2)
        recall_VST3=cal_recall(TP_VST3,FN_VST3)
        recall_VST3_random_mean.append(recall_VST3)
        recall_ST3=cal_recall(TP_ST3,FN_ST3)
        recall_ST3_random_mean.append(recall_ST3)
        recall_MT3=cal_recall(TP_MT3,FN_MT3)
        recall_MT3_random_mean.append(recall_MT3)
        recall_WT3_T4=cal_recall(TP_WT3_T4,FN_WT3_T4)
        recall_WT3_T4_random_mean.append(recall_WT3_T4)
        
        precision_random_mean.append(p)
        recall_random_mean.append(r)
        yuzhi_random_mean.append(key)
...
###random_Root模型  
    ...
    yuzhi_random_root=[]
    FPR_random_root=[]
    recall_T1_random_root=[]
    recall_T2_random_root=[]
    recall_VST3_random_root=[]
    recall_ST3_random_root=[]
    recall_MT3_random_root=[]
    recall_WT3_T4_random_root=[]
    for obj in result_random_root.items():
        ...
        recall_T1=cal_recall(TP_T1,FN_T1)
        recall_T1_random_root.append(recall_T1)
        recall_T2=cal_recall(TP_T2c+TP_T2b,FN_T2c+FN_T2b)
        recall_T2_random_root.append(recall_T2)
        recall_VST3=cal_recall(TP_VST3,FN_VST3)
        recall_VST3_random_root.append(recall_VST3)
        recall_ST3=cal_recall(TP_ST3,FN_ST3)
        recall_ST3_random_root.append(recall_ST3)
        recall_MT3=cal_recall(TP_MT3,FN_MT3)
        recall_MT3_random_root.append(recall_MT3)
        recall_WT3_T4=cal_recall(TP_WT3_T4,FN_WT3_T4)
        recall_WT3_T4_random_root.append(recall_WT3_T4)
        
        precision_random_root.append(p)
        recall_random_root.append(r)
        yuzhi_random_root.append(key)
...
###traditionalRAE_mean模型  
    precision_traditionalRAE_mean=[]
    recall_traditionalRAE_mean=[]
    yuzhi__traditionalRAE_mean=[]
    FPR_traditionalRAE_mean=[]
    recall_T1_traditionalRAE_mean=[]
    recall_T2_traditionalRAE_mean=[]
    recall_VST3_traditionalRAE_mean=[]
    recall_ST3_traditionalRAE_mean=[]
    recall_MT3_traditionalRAE_mean=[]
    recall_WT3_T4_traditionalRAE_mean=[]
    for obj in result_traditionalRAE_mean.items():
        key,value=obj
        TP,TN,FP,FN,TP_T1,TP_T2c,TP_T2b,TP_VST3,TP_ST3,TP_MT3,TP_WT3_T4,FN_T1,FN_T2c,FN_T2b,FN_VST3,FN_ST3,FN_MT3,FN_WT3_T4=value
        p=cal_precision(TP, FP)
        r=cal_recall(TP, FN)
        ...
        recall_T1=cal_recall(TP_T1,FN_T1)
        recall_T1_traditionalRAE_mean.append(recall_T1)
        recall_T2=cal_recall(TP_T2c+TP_T2b,FN_T2c+FN_T2b)
        recall_T2_traditionalRAE_mean.append(recall_T2)
        recall_VST3=cal_recall(TP_VST3,FN_VST3)
        recall_VST3_traditionalRAE_mean.append(recall_VST3)
        recall_ST3=cal_recall(TP_ST3,FN_ST3)
        recall_ST3_traditionalRAE_mean.append(recall_ST3)
        recall_MT3=cal_recall(TP_MT3,FN_MT3)
        recall_MT3_traditionalRAE_mean.append(recall_MT3)
        recall_WT3_T4=cal_recall(TP_WT3_T4,FN_WT3_T4)
        recall_WT3_T4_traditionalRAE_mean.append(recall_WT3_T4)
        
        precision_traditionalRAE_mean.append(p)
        recall_traditionalRAE_mean.append(r)
        yuzhi__traditionalRAE_mean.append(key)
        FPR_traditionalRAE_mean.append(FPR)
...
###weightedRAE_Weighted模型 
    precision_weightedRAE_Weighted=[]
    recall_weightedRAE_Weighted=[]
    yuzhi_weightedRAE_Weighted=[]
    FPR_weightedRAE_Weighted=[]
    recall_T1_weightedRAE_Weighted=[]
    recall_T2_weightedRAE_Weighted=[]
    recall_VST3_weightedRAE_Weighted=[]
    recall_ST3_weightedRAE_Weighted=[]
    recall_MT3_weightedRAE_Weighted=[]
    recall_WT3_T4_weightedRAE_Weighted=[]
    for obj in result_weightedRAE_Weighted.items():
        key,value=obj
        TP,TN,FP,FN,TP_T1,TP_T2c,TP_T2b,TP_VST3,TP_ST3,TP_MT3,TP_WT3_T4,FN_T1,FN_T2c,FN_T2b,FN_VST3,FN_ST3,FN_MT3,FN_WT3_T4=value
        p=cal_precision(TP, FP)
        r=cal_recall(TP, FN)
        ...
        recall_T1=cal_recall(TP_T1,FN_T1)
        recall_T1_weightedRAE_Weighted.append(recall_T1)
        recall_T2=cal_recall(TP_T2c+TP_T2b,FN_T2c+FN_T2b)
        recall_T2_weightedRAE_Weighted.append(recall_T2)
        recall_VST3=cal_recall(TP_VST3,FN_VST3)
        recall_VST3_weightedRAE_Weighted.append(recall_VST3)
        recall_ST3=cal_recall(TP_ST3,FN_ST3)
        recall_ST3_weightedRAE_Weighted.append(recall_ST3)
        recall_MT3=cal_recall(TP_MT3,FN_MT3)
        recall_MT3_weightedRAE_Weighted.append(recall_MT3)
        recall_WT3_T4=cal_recall(TP_WT3_T4,FN_WT3_T4)
        recall_WT3_T4_weightedRAE_Weighted.append(recall_WT3_T4)
        
        precision_weightedRAE_Weighted.append(p)
        recall_weightedRAE_Weighted.append(r)
        yuzhi_weightedRAE_Weighted.append(key)
        FPR_weightedRAE_Weighted.append(FPR)

###weightedRAE_root模型 
    precision_weightedRAE_root=[]
    recall_weightedRAE_root=[]
    yuzhi_weightedRAE_root=[]
    FPR_weightedRAE_root=[]
    recall_T1_weightedRAE_root=[]
    recall_T2_weightedRAE_root=[]
    recall_VST3_weightedRAE_root=[]
    recall_ST3_weightedRAE_root=[]
    recall_MT3_weightedRAE_root=[]
    recall_WT3_T4_weightedRAE_root=[]
    for obj in result_weightedRAE_root.items():
        key,value=obj
        TP,TN,FP,FN,TP_T1,TP_T2c,TP_T2b,TP_VST3,TP_ST3,TP_MT3,TP_WT3_T4,FN_T1,FN_T2c,FN_T2b,FN_VST3,FN_ST3,FN_MT3,FN_WT3_T4=value
        p=cal_precision(TP, FP)
        r=cal_recall(TP, FN)
        ...
        recall_T1=cal_recall(TP_T1,FN_T1)
        recall_T1_weightedRAE_root.append(recall_T1)
        recall_T2=cal_recall(TP_T2c+TP_T2b,FN_T2c+FN_T2b)
        recall_T2_weightedRAE_root.append(recall_T2)
        recall_VST3=cal_recall(TP_VST3,FN_VST3)
        recall_VST3_weightedRAE_root.append(recall_VST3)
        recall_ST3=cal_recall(TP_ST3,FN_ST3)
        recall_ST3_weightedRAE_root.append(recall_ST3)
        recall_MT3=cal_recall(TP_MT3,FN_MT3)
        recall_MT3_weightedRAE_root.append(recall_MT3)
        recall_WT3_T4=cal_recall(TP_WT3_T4,FN_WT3_T4)
        recall_WT3_T4_weightedRAE_root.append(recall_WT3_T4)
        
        precision_weightedRAE_root.append(p)
        recall_weightedRAE_root.append(r)
        yuzhi_weightedRAE_root.append(key)
        FPR_weightedRAE_root.append(FPR)
    ...
    plt.plot(recall_random_root,precision_random_root,'g.-',label='random_RAE')
#    plt.plot(recall_traditionalRAE_mean,precision_traditionalRAE_mean,label='traditional_RAE_mean')
    plt.plot(recall_weightedRAE_root,precision_weightedRAE_root,'m.-',label='weighted_RAE')
...
#    plt.show()
    ...
    plt.plot(FPR_random_root,recall_random_root,'g.-',label='random_RAE')
    
#    plt.plot(FPR_traditionalRAE_mean,recall_traditionalRAE_mean,label='traditional_RAE_mean')
    plt.plot(FPR_weightedRAE_root,recall_weightedRAE_root,'m.-',label='weighted_RAE')
...
#    plt.axis('equal')
    ...
    plt.plot(FPR_random_root,recall_T1_random_root,'g.-',label='random_RAE')
#    plt.plot(FPR_traditionalRAE_mean,recall_T1_traditionalRAE_mean,label='traditional_RAE_mean')
    plt.plot(FPR_weightedRAE_root,recall_T1_weightedRAE_root,'m.-',label='weighted_RAE')
...
#    plt.axis('equal')
    ...
    plt.plot(FPR_random_root,recall_T2_random_root,'g.-',label='random_RAE')
#    plt.plot(FPR_traditionalRAE_mean,recall_T2_traditionalRAE_mean,label='traditional_RAE_mean')
    plt.plot(FPR_weightedRAE_root,recall_T2_weightedRAE_root,'m.-',label='weighted_RAE')
...
#    plt.axis('equal')
    ...
    plt.plot(FPR_random_root,recall_VST3_random_root,'g.-',label='random_RAE')
#    plt.plot(FPR_traditionalRAE_mean,recall_VST3_traditionalRAE_mean,label='traditional_RAE_mean')
    plt.plot(FPR_weightedRAE_root,recall_VST3_weightedRAE_root,'m.-',label='weighted_RAE')
...
#    plt.plot(FPR_traditionalRAE_mean,recall_ST3_traditionalRAE_mean,label='traditional_RAE_mean')
    plt.plot(FPR_weightedRAE_root,recall_ST3_weightedRAE_root,'m.-',label='weighted_RAE')
    plt.plot(FPR_random_root,recall_ST3_random_root,'g.-',label='random_RAE')
...
#    plt.plot(FPR_traditionalRAE_mean,recall_MT3_traditionalRAE_mean,label='traditional_RAE_mean')
    plt.plot(FPR_weightedRAE_root,recall_MT3_weightedRAE_root,'m.-',label='weighted_RAE')
    plt.plot(FPR_random_root,recall_MT3_random_root,'g.-',label='random_RAE')
...
#    plt.plot(FPR_traditionalRAE_mean,recall_WT3_T4_traditionalRAE_mean,label='traditional_RAE_mean')
    plt.plot(FPR_random_root,recall_WT3_T4_random_root,'g.-',label='random_RAE')
    plt.plot(FPR_weightedRAE_root,recall_WT3_T4_weightedRAE_root,'m.-',label='weighted_RAE')
