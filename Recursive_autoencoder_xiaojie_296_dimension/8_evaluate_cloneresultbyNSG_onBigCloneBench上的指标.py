...
def analyse_experimentID4(metrics_pkl):
...
#    analyse_experimentID4(metrices_onFullCorpusWithNSG_WeightedRAE)
    #####去计算相关指标,存入相关pkl文件
    ##保存到pkl文件以后，后续可以直接读取
    result_onFullCorpusWithNSG_WeightedRAE=read_from_pkl(metrices_onFullCorpusWithNSG_WeightedRAE)
    ##########绘制PR曲线
    ###取出没有NSG的
...
###NSG and weighted模型 result_onFullCorpusWithNSG_WeightedRAE
    precision_weightedRAE_NSG=[]
    recall_weightedRAE_NSG=[]
    yuzhi_weightedRAE_NSG=[]
    FPR_weightedRAE_NSG=[]
    recall_T1_weightedRAE_NSG=[]
    recall_T2_weightedRAE_NSG=[]
    recall_VST3_weightedRAE_NSG=[]
    recall_ST3_weightedRAE_NSG=[]
    recall_MT3_weightedRAE_NSG=[]
    recall_WT3_T4_weightedRAE_NSG=[]
    for obj in result_onFullCorpusWithNSG_WeightedRAE.items():
        key,value=obj
        TP,TN,FP,FN,TP_T1,TP_T2c,TP_T2b,TP_VST3,TP_ST3,TP_MT3,TP_WT3_T4,FN_T1,FN_T2c,FN_T2b,FN_VST3,FN_ST3,FN_MT3,FN_WT3_T4=value
        p=cal_precision(TP, FP)
        r=cal_recall(TP, FN)
        ...
        recall_T1=cal_recall(TP_T1,FN_T1)
        recall_T1_weightedRAE_NSG.append(recall_T1)
        recall_T2=cal_recall(TP_T2c+TP_T2b,FN_T2c+FN_T2b)
        recall_T2_weightedRAE_NSG.append(recall_T2)
        recall_VST3=cal_recall(TP_VST3,FN_VST3)
        recall_VST3_weightedRAE_NSG.append(recall_VST3)
        recall_ST3=cal_recall(TP_ST3,FN_ST3)
        recall_ST3_weightedRAE_NSG.append(recall_ST3)
        recall_MT3=cal_recall(TP_MT3,FN_MT3)
        recall_MT3_weightedRAE_NSG.append(recall_MT3)
        recall_WT3_T4=cal_recall(TP_WT3_T4,FN_WT3_T4)
        recall_WT3_T4_weightedRAE_NSG.append(recall_WT3_T4)
        
        precision_weightedRAE_NSG.append(p)
        recall_weightedRAE_NSG.append(r)
        yuzhi_weightedRAE_NSG.append(key)
        FPR_weightedRAE_NSG.append(FPR)
    ...
    fig = plt.figure(num=1, figsize=(15, 8),dpi=80) 
    plt.plot(recall_weightedRAE_NSG,precision_weightedRAE_NSG,'c*-',label='weighted_RAE_NSG')
    plt.plot(recall_weightedRAE_Weighted,precision_weightedRAE_Weighted,'m.-',label='weighted_RAE')
    plt.legend()
    plt.show()
    ...
    fig = plt.figure(num=2, figsize=(15, 8),dpi=80) 
    plt.plot(yuzhi_weightedRAE_NSG,recall_weightedRAE_NSG,'c*-',label='weighted_RAE_NSG')
    plt.plot(yuzhi_weightedRAE_Weighted,recall_weightedRAE_Weighted,'m.-',label='weighted_RAE')
    plt.legend()
    plt.show()
    ...
    fig = plt.figure(num=3, figsize=(15, 8),dpi=80) 
    plt.plot(FPR_weightedRAE_NSG,recall_weightedRAE_NSG,'c*-',label='weighted_RAE_NSG')
    ...
    plt.ylabel('TPR')
    fig = plt.figure(num=4, figsize=(15, 8),dpi=80) 
    plt.plot(FPR_weightedRAE_NSG,recall_T1_weightedRAE_NSG,'c*-',label='weighted_RAE_NSG')
    plt.plot(FPR_weightedRAE_Weighted,recall_T1_weightedRAE_Weighted,'m.-',label='weighted_RAE')
    plt.legend()
    ...
    fig = plt.figure(num=5, figsize=(15, 8),dpi=80) 
    plt.plot(FPR_weightedRAE_NSG,recall_T2_weightedRAE_NSG,'c*-',label='weighted_RAE_NSG')
    plt.plot(FPR_weightedRAE_Weighted,recall_T2_weightedRAE_Weighted,'m.-',label='weighted_RAE')
    plt.legend()
    ...
    fig = plt.figure(num=6, figsize=(15, 8),dpi=80) 
    plt.plot(FPR_weightedRAE_NSG,recall_VST3_weightedRAE_NSG,'c*-',label='weighted_RAE_NSG')
    plt.plot(FPR_weightedRAE_Weighted,recall_VST3_weightedRAE_Weighted,'m.-',label='weighted_RAE')
    plt.legend()
    ...
    fig = plt.figure(num=7, figsize=(15, 8),dpi=80) 
    plt.plot(FPR_weightedRAE_NSG,recall_ST3_weightedRAE_NSG,'c*-',label='weighted_RAE_NSG')
    plt.plot(FPR_weightedRAE_Weighted,recall_ST3_weightedRAE_Weighted,'m.-',label='weighted_RAE')
    plt.legend()
    ...
    fig = plt.figure(num=8, figsize=(15, 8),dpi=80) 
    plt.plot(FPR_weightedRAE_NSG,recall_MT3_weightedRAE_NSG,'c*-',label='weighted_RAE_NSG')
    plt.plot(FPR_weightedRAE_Weighted,recall_MT3_weightedRAE_Weighted,'m.-',label='weighted_RAE')
    plt.legend()
        ###设置坐标轴
    x_major_locator=MultipleLocator(0.1)#间隔为0.1
    y_major_locator=MultipleLocator(0.1)#间隔为0.1
    ...
    fig = plt.figure(num=9, figsize=(15, 8),dpi=80) 
    plt.plot(FPR_weightedRAE_NSG,recall_WT3_T4_weightedRAE_NSG,'c*-',label='weighted_RAE_NSG')
    plt.plot(FPR_weightedRAE_Weighted,recall_WT3_T4_weightedRAE_Weighted,'m.-',label='weighted_RAE')
    plt.legend()
        ###设置坐标轴
    x_major_locator=MultipleLocator(0.1)#间隔为0.1
    y_major_locator=MultipleLocator(0.1)#间隔为0.1
